"""Shared building blocks for every pygame-kit UI widget.
...
If you want to make **your own** widget, subclass :class:`Widget`::
    ...
    from pygame_kit.ui import Widget
...
class Widget:
    ...
    Every widget in pygame-kit follows the same three-step pattern, so once you
