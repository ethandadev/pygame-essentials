"""Every pygame-kit UI widget on one screen.
...
pygame.display.set_caption("pygame-kit UI demo")
clock = pygame.time.Clock()

BG = (245, 246, 250)
DARK = (30, 30, 40)

title = pk.Label((400, 40), "pygame-kit UI demo", font_size=48, color=DARK, anchor="center")
